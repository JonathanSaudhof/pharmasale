...
//   Route::get('/new', [App\Http\Controllers\UserController::class, 'create'])->name('user.create');
...
//   Route::get('/new', [App\Http\Controllers\RegionController::class, 'create'])->name('region.create');
...
//   Route::post('/',[App\Http\Controllers\RegionController::class, 'store'])->name('region.store');
...
//   Route::get('/new', [App\Http\Controllers\PharmacyController::class, 'create'])->name('pharmacy.create');
...
//   Route::post('/',[App\Http\Controllers\PharmacyController::class, 'store'])->name('pharmacy.store');
...
//   Route::get('/new/{pharmacyId?}', [App\Http\Controllers\AppointmentController::class, 'create'])->name('appointment.create');
