        ...
        <div
            ...
            <a href="{{ route('pharmacy.create') }}">
                <button
                    ...
                    + New Pharamacy</button>
            </a>
        </div>
        <table
            class="col-10 ml-auto mr-auto border-collapse shadow-sm overflow-hidden rounded border-gray-200 sm:rounded-lg divide-y divide-gray-200">
            <thead>
                <tr class="border">
                    <th
