...
@section('content')
    <div class="container items-center justify-center">
        ...
        <form class="m-auto flex flex-column items-start shadow-sm col-10 p-6 bg-white rounded" method="POST"
            ...
            <input class="border rounded py-2 px-3 mb-2 w-full" type="text" name="name" placeholder="Pharmacy Jon Doe"
                id="pharmacy-name" />
            <hr class="my-3" />
            ...
            <div class="street_container w-full flex justify-between">
                <div class="street-name-wrapper w-3/4 pr-2">
                    ...
                    <input class="w-full border rounded py-2 px-3 mb-2" type="text" name="adress_street"
                        placeholder="Frankfurter Allee" id="pharmacy-street" />
                </div>
                <div class="building-number-wrapperpl-2 w-1/4">
                    ...
                    <input class="w-full border rounded py-2 px-3 mb-2" type="text" name="adress_building_number"
                        placeholder="100" id="pharmacy-building-number" />
                </div>
            </div>
            <div class="city_container w-full flex">
                <div class="street-name-wrapper  inline w-1/4 pr-2">
                    ...
                    <input class="block w-full border rounded py-2 px-3 mb-2" type="text" name="adress_zip_code"
                        placeholder="99999" id="pharmacy-zip-code" />
                </div>
                <div class="building-number-wrapper  inline  pl-2 w-3/4">
                    ...
                    <input class="block w-full border rounded py-2 px-3 mb-2" type="text" name="adress_city"
                        placeholder="Berlin" id="pharmacy-city" />
                </div>
                ...
                <div
                    ...
                    <div id="collapseTwo" class="contact-body collapse mt-3" aria-labelledby="headingTwo"
                        ...
                        <input class="block w-full border rounded py-2 px-3 mb-2" type="text" name="contact_name"
                            placeholder="Jon Doe" id="contact_name" />
                        ...
                        <input class="block w-full border rounded py-2 px-3 mb-2" type="text" name="contact_email"
                            placeholder="Jon Doe" id="contact_email" />
                        ...
                        <input class="block w-full border rounded py-2 px-3 mb-2" type="text" name="contact_phone"
                            placeholder="017631215960" id="contact_phone" />
                    </div>
                </div>
