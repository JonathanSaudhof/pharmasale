...
<div class="container">
  ...
  <div class="col-10 flex justify-between items-center rounded mx-auto mb-6 px-6 py-3 shadow-sm bg-gray-100 border border-gray-500">
    ...
    <div class="button-container">
      ...
      <a href="{{route('pharmacy.edit', $pharmacy->id)}}"><button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded">✏️</button></a>
      <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded" onclick="openClose('delete', '{{$pharmacy->id}}')" >🗑</button>
    </div>
  </div>
  <div class="col-10 flex mx-auto p-0 mb-5">
    <table class="w-1/2 divide-x divide-gray-200 shadow-sm overflow-hidden border border-gray-500 sm:rounded-lg  mr-1">
      <thead>
        <tr>
          <th class="px-6 py-3 bg-gray-300 text-left text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider" colspan='2'>Adress</th>
        </tr>
      </thead>
    ...
    <table class="w-1/2 divide-x divide-gray-200 shadow-sm overflow-hidden border border-gray-500 sm:rounded-lg">
      <thead>
        <tr>
          <th class="px-6 py-3 bg-gray-300 text-left text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider" colspan='2'>Contact</th>
        </tr>
      </thead>
      <tbody class=" border divide-y divide-gray-200">
        <tr>
          ...
          <td class="px-6 py-4 whitespace-no-wrap w-1 bg-white {{!$pharmacy->contact_name ? "text-gray-300": ""}}">
      ...
      <tr>
          ...
          <td class="px-6 py-4 whitespace-no-wrap w-1 bg-white {{!$pharmacy->contact_email ? "text-gray-300": ""}}">
      ...
      <tr>
          ...
          <td class="px-6 py-4 whitespace-no-wrap w-1 bg-white {{!$pharmacy->contact_phone ? "text-gray-300": ""}}">
  ...
  <table class="col-10 ml-auto mr-auto divide-y divide-gray-200 shadow-sm overflow-hidden border border-gray-500 sm:rounded-lg">
    <thead>
      <tr>
        <th class="px-6 py-3 bg-gray-300 text-left text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider" colspan='4'>
          appointments
          
        </th>
        <th class="px-6 py-3 bg-gray-300 text-left text-xs leading-4 font-medium text-gray-700 uppercase tracking-wider flex justify-end">
          <a href="{{route('appointment.create',$pharmacy->id)}}"><button class="ml-auto bg-white hover:bg-gray-100 text-gray-800 font-semibold py-1 px-2 border border-gray-400 rounded">+ Add</button></a>
        </th>
      </tr>
      <tr>
        ...
        <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Starts at</th>
        <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Ends at</th>
      </tr>
    </thead>
    <tbody class="bg-white border divide-y divide-gray-200">
      ...
      <tr class="border">
          ...
          <td class="px-6 py-4 whitespace-no-wrap">
            <a href="{{route('appointment.show', $appointment->id)}}">{{$appointment->user->name}}</a>
          </td>
          <td class="px-6 py-4">
