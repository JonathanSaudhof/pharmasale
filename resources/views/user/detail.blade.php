    ...
    <div class="container">
        <div
            ...
            <div class="button-container">
                ...
                <button
                    class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded"
                    onclick="openClose('delete', '{{ $user->id }}')">🗑</button>
            </div>
        </div>
        <table
            class="col-10 ml-auto mr-auto divide-x divide-gray-200 shadow-sm overflow-hidden border border-gray-500 sm:rounded-lg">
            ...
            <div role="alert" class="shadow w-1/4">
                ...
                <div
                    ...
                    <button class='border hover:bg-blue-700 hover:text-white text-black font-bold py-2 px-4 rounded'
                        onclick="openClose('delete', '{{ $user->id }}');">No</button>
                </div>
