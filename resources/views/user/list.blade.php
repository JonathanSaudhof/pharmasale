...
<div class="container">
  <div class="col-10 sticky flex justify-between items-center rounded mx-auto mb-6 px-6 py-3 shadow-sm bg-gray-50 border border-gray-500">
    ...
    <a href="{{route('user.create')}}" >
     <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded"> + New User</button>
    </a>
  </div>
  <table class="col-10 ml-auto mr-auto divide-y divide-gray-200 shadow-sm overflow-hidden border border-gray-500 sm:rounded-lg">
    ...
    <tr class="border">
        ...
        <td class="px-6 py-4 whitespace-no-wrap w-1">
          <button onclick="openClose('delete', '{{$user->id}}')" >🗑</button>
