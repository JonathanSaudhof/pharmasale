...
@section('content')
  ...
  <div class="container items-center justify-center">
    <div class="col-10 sticky flex justify-between items-center rounded mx-auto mb-6 px-6 py-3 shadow-sm bg-gray-50 border border-gray-500"><h1>👩🏻‍💻 Create new user</h1>
    ...
    <form class="m-auto flex flex-column shadow-sm col-10 p-6 bg-white rounded" method="POST" action="{{route('user.store')}}">
      @csrf
      <label class="py-2 font-bold text-base">Username:</label>
      <input class="block border rounded py-2 px-3 mb-2" type="text" name="name" placeholder="Jon Doe" id="user-name"/>
